...
// Add utility functions to filter/search questions
questions.getByCategory = function (category) {
        return this.questions.filter(q => q.category === category);
};

questions.getNewQuestions = function () {
        return this.questions.filter(q => q.new);
};

questions.getCategories = function () {
        return [...new Set(this.questions.map(q => q.category))];
};

questions.getSubcategories = function (category) {
        return [...new Set(this.questions
